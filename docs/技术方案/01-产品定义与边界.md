...
source-range: "规格书 §1、§1.1–§1.3；v1.1 新增可选 AI Agent 产品边界；v1.2 多目标与双语产品化边界；v1.3 Cursor/VS Code 源码导航与开源入口"
参考文献/依赖:
...
- 默认自动识别 Cursor 或 VS Code；无法启动时给出可见、双语且可操作的反馈，不能以“请求已发送”冒充打开成功。
