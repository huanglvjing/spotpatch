...
source-range: "规格书 §2.4 第 3 条、§18、§18.1–§18.3、§22；v1.1 Agent 工作台与变更审阅；v1.2 多目标工作台；v1.3 品牌视觉、双语与逐目标编辑；v1.4 低密度 Agent 布局与入口层级"
参考文献/依赖:
...
- ModelSelector：只选择可信配置登记的 provider/model profile。
- AgentProgress：展示当前阶段、有界工具活动和取消入口。
- DiffReview：展示文件列表、完整 Diff、检查结果和 Apply/Revert 门禁。
- Actions：追加元素、复制、重新选择、打开活动目标的 VS Code、关闭。
