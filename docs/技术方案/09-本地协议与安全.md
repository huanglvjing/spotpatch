...
source-range: "规格书 §2.3、§9.1 末段、§12.3–§12.4、§14–§15、§25.2；v1.1 Agent 本地协议与安全边界；v1.2 多目标授权；v1.3 schema v3 逐目标说明校验；v1.4 编辑器启动确认；v1.5 实际编辑器响应；v1.6 工作区健康与本地修改授权；v1.7 工具轮次作用域与精确诊断"
参考文献/依赖:
