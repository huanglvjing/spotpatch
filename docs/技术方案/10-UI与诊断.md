...
source-range: "规格书 §2.4 第 3 条、§18、§18.1–§18.3、§22；v1.1 Agent 工作台与变更审阅；v1.2 多目标工作台；v1.3 品牌视觉、双语与逐目标编辑；v1.4 低密度 Agent 布局与入口层级；v1.5 源码快捷入口与开源传播；v1.6 深色原生选择控件；v1.7 工作区健康、显式同意与渐进增强选择器；v1.8 工具轮次活动与精确错误诊断；v1.9 直接运行、可选能力诊断与严格 CSP nonce 继承"
参考文献/依赖:
